    ...
    <>
      <div className="bg-offWhite py-4 sm:py-12">
        <div className="container mx-auto px-4 sm:px-0">
          ...
          <div
            className="flex gap-4 items-center flex-col sm:flex-row sm:pb-4"
          ...
          >
            ...
            >
              ...
              <p className="sm:text-base text-center font-extralight text-slate-700 sm:pt-4">
            ...
            >
              ...
              <h1 className="text-xl sm:text-xl text-brand text-center">Deposits</h1>
              <p className="sm:text-base text-center font-extralight text-slate-700 sm:pt-4">
