    ...
    <>
      ...
      >
        <div className="text-center">
          ...
          <p className="font-roboto text-slate-900 sm:text-xl tracking-normal font-light py-4 sm:mx-60 px-4 sm:px-0">
        ...
        <div className="container mx-auto py-4 sm:py-16">
          <div className="flex gap-8 flex-col sm:flex-row px-4 sm:px-0">
            <div
              ...
              data-aos-once="true"
            >
              <h3 className="text-2xl sm:text-4xl font-medium font-roboto tracking-wide pb-2 text-center">
                Our <span className="text-brand">Features</span>
              </h3>
              <div className=" bg-white p-6 flex flex-col gap-6 sm:h-[540px] shadow-md border">
                <div className="flex gap-4 items-center">
                  <div>
                    <p className="w-10 h-10 rounded-full bg-brand text-white flex justify-center items-center sm:text-2xl">
                      1
                    </p>
                  </div>
                  <div>
                    <p className="text-slate-900 font-light sm:text-xl">
            ...
            <div
              ...
              data-aos-once="true"
            >
              <h3 className="text-2xl sm:text-4xl font-medium font-roboto tracking-wide pb-2 text-center sm:text-left">
              ...
              <div className=" bg-white p-6 flex flex-col gap-6 sm:h-[540px] shadow-md border">
                <div className="flex gap-4 items-center">
                  <div>
                    <p className="w-10 h-10 bg-brand text-white flex justify-center items-center sm:text-2xl">
                      1
                    </p>
                  </div>
                  <div>
